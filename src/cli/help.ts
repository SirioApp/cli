...
Factory:
  ...
  backed factory create --agent-id <id> --name <name> --description <text> --token-name <name> --token-symbol <symbol> --duration-minutes <n> [--launch-in-minutes <n>] [--categories <csv>] [--agent-address <address>] [--collateral <address>]
